 ...
 * @const
 */
proto.rpcpb.RegisterReq.oneofGroups_ = [[2]];
 ...
 * @const
 */
proto.rpcpb.ListenedData.oneofGroups_ = [[2,3]];
 ...
 * @const
 */
proto.rpcpb.LogsReq.repeatedFields_ = [4,5];
...
proto.rpcpb.LogsReq.prototype.getTopicsList = function() {
  return /** @type{!Array<!proto.rpcpb.LogsReq.topiclist>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.rpcpb.LogsReq.topiclist, 5));
};
...
proto.rpcpb.LogsReq.prototype.addTopics = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.rpcpb.LogsReq.topiclist, opt_index);
};
 ...
 * @const
 */
proto.rpcpb.TxOutDetail.oneofGroups_ = [[6,7,8,9]];
