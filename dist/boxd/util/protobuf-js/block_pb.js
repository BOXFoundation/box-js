...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.corepb.BlockHeader.toObject = function (includeInstance, msg) {
    var f,obj = {
      ...
      dynastyHash: msg.getDynastyHash_asB64(),
...
/**
    * optional bytes dynasty_hash = 9;
    * @return {!(string|Uint8Array)}
    */
proto.corepb.BlockHeader.prototype.getDynastyHash = function () {
...
/**
    * optional bytes dynasty_hash = 9;
    * This is a type-conversion wrapper around `getDynastyHash()`
    * @return {string}
    */
proto.corepb.BlockHeader.prototype.getDynastyHash_asB64 = function () {
  return (/** @type {string} */jspb.Message.bytesAsB64(
    this.getDynastyHash()));
};
...
/**
    ...
    * @return {!Uint8Array}
    */
proto.corepb.BlockHeader.prototype.getDynastyHash_asU8 = function () {
  return (/** @type {!Uint8Array} */jspb.Message.bytesAsU8(
    this.getDynastyHash()));
};
...
/** @param {!(string|Uint8Array)} value */
proto.corepb.BlockHeader.prototype.setDynastyHash = function (value) {
  jspb.Message.setProto3BytesField(this, 9, value);
};


/**
    * optional bytes root_hash = 10;
    * @return {!(string|Uint8Array)}
    */
...
/**
    * optional bytes bloom = 14;
    * @return {!(string|Uint8Array)}
    */
proto.corepb.BlockHeader.prototype.getBloom = function () {
...
/**
    ...
    * @return {string}
    */
proto.corepb.BlockHeader.prototype.getBloom_asB64 = function () {
  return (/** @type {string} */jspb.Message.bytesAsB64(
    this.getBloom()));
};
...
/**
    ...
    * @return {!Uint8Array}
    */
proto.corepb.BlockHeader.prototype.getBloom_asU8 = function () {
  return (/** @type {!Uint8Array} */jspb.Message.bytesAsU8(
    this.getBloom()));
};
...
/** @param {!(string|Uint8Array)} value */
proto.corepb.BlockHeader.prototype.setBloom = function (value) {
