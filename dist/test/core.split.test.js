...
test('Make a Split Contract Transaction', function () { return __awaiter(_this, void 0, void 0, function () {
    var tx_result, tx_detail;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, feature.makeSplitTxByCrypto({
                    tx: {
                        from: data_json_1.default.acc_addr_1,
                        addrs: data_json_1.default.to_addrs,
                        weights: data_json_1.default.split_weights,
                        fee: data_json_1.default.fee
                    },
                    crypto: keystore_json_1.default.keystore_1,
