...
import Contract from '../src/boxd/core/contract/index'
...
test('Send a contract method', async () => {
  ...
  const tx_result = await contract.methods.incrementBalance(depositAmount).send()
